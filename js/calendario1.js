...
function escribirdias() {
         ...
         //Recorrer las celdas para escribir el d&iacute;a:
         for (i=1;i<7;i++) { //localizar fila
             ...
             for (j=0;j<7;j++) {
                 ...
                 celda.innerHTML=midia;
								 //Recuperar el estado inicial al cambiar de mes
...
function mesantes() {
         ...
         primeromes--; //Restamos un d&iacute;a al 1 del mes visualizado
         nuevomes.setTime(primeromes) //cambiamos fecha al mes anterior 
         mescal=nuevomes.getMonth() //cambiamos las variables que usar&aacute;n las funciones
...
function mesdespues() {
         ...
         tiempounix=primeromes.getTime() //tiempo de primero mes visibble
         tiempounix=tiempounix+(45*24*60*60*1000) //le a&ntilde;adimos 45 d&iacute;as 
...
function actualizar() {
         ...
         annocal=hoy.getFullYear(); //cambiar a a&ntilde;o actual 
         cabecera() //escribir la cabecera
         escribirdias() //escribir la tabla
         }
//ir al mes buscado
function mifecha() {
         //Recoger dato del a&ntilde;o en el formulario
         ...
         //Comprobar si el a&ntilde;o est&aacute; bien escrito
         if (isNaN(mianno) || mianno<1) { 
            //a&ntilde;o mal escrito: mensaje de error
            alert("El a&ntilde;o no es v&aacute;lido:\n debe ser un n&uacute;mero mayor que 0")
            }
         else { //a&ntilde;o bien escrito: ver mes en calendario:
              mife=new Date(); //nueva fecha
              mife.setMonth(mimes); //a&ntilde;adir mes y a&ntilde;o a nueva fecha
              mife.setFullYear(mianno);
              mescal=mife.getMonth(); //cambiar a mes y a&ntilde;o indicados
